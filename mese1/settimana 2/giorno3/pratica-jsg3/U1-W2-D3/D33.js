...
/* ESERCIZIO 3
 ...
 for(let i = 0; i < starWarsCharacters.length; i++){
    if(starWarsCharacters[i].gender === 'female'){
        femaleObject.push(starWarsCharacters[i]);
        }
 }

    starWarsCharacters.forEach(function(object){
        if(object.gender === 'female'){
            femaleObject.push(object);
        }
    })
...
/* ESERCIZIO 4
  ...
  */ /* ESERCIZIO 5
    ...
    starWarsCharacters.forEach((obj) =>{
...
/* ESERCIZIO 7
 ...
 let crewMass = 500;
 function controlCrewMass(massTot) {
    if(massTot > 1000)
...
/* --EXTRA-- ESERCIZIO 9
    ...
    for (let i = 0; i < femaleObject.length; i++) {
        let index = characters.indexOf(femaleObject[i].name);
        if (index !== -1) {
...
/* --EXTRA-- ESERCIZIO 10
    ...
    function casualObj(){
        ...
        let objStarWars = starWarsCharacters[indexRamdom];
        console.log("Ciao a tutti io mi chiamo " + `${objStarWars.name}`+ " sono alto " + `${objStarWars.height}`+"cm"+
            " e peso " + `${objStarWars.mass}`+"Kg."+
            " I miei capelli sono di colore "+`${objStarWars.hair_color}`+" e i miei occhi invece di color "+`${objStarWars.eye_color}`
            +" Sono nato nel "+`${objStarWars.birth_year}`+ " e sono un/una "+`${objStarWars.gender}`
         );    
    }
